...
const OrderForm = ({ listOrders, onClose, onCancel, onApply, onPrintBill, status, statusHeader, orderID, trangThaiBtn }) => {
                ...
                <tr className='order-form_tbody__row'>
                    ...
                    <td style={{ width: '100px' }}>{orderDetail.so_luong}</td>
                    {
                        orderDetail.phuong_thuc_thanh_toan?.id === 3 ? (
                            <>
                                <td style={{ width: '120px' }}>{orderDetail.san_pham?.gia_sol} SOL</td>
                                <td style={{ width: '120px' }}>{orderDetail.thanh_tien} SOL</td>
                            </>
                        ) : (
                            <>
                ...
                orderDetail && (
                    <div className="order-form">
                        ...
                        <div className="order-form_info">
                            ...
                            <p><strong>Phương thức thanh toán:</strong> {orderDetail.phuong_thuc_thanh_toan?.ten_phuong_thuc}</p>
                            <p><strong>Đơn vị vận chuyển:</strong> {orderDetail.don_vi_van_chuyen}</p>
                            <p><strong>Phí vận chuyển:</strong> {orderDetail.phi_van_chuyen}</p>
                            ...
                            {
                                orderDetail.phuong_thuc_thanh_toan?.id === 3 ? (
<p style={{ fontSize: '23px' }}><strong>Tổng tiền:</strong> {orderDetail.thanh_tien} SOL</p>
                                ) : (
